...
export default function MarketplacePage() {
  ...
  const [projectType, setProjectType] = useState<
    "all" | "my_projects" | "accepted_projects"
  >("all");

  // Sync state with URL param on mount/change
  useEffect(() => {
    if (filterParam === "my_projects") setProjectType("my_projects");
    else if (filterParam === "accepted_projects")
      setProjectType("accepted_projects");
  ...
  const fetchProjects = useCallback(async () => {
    ...
    try {
      ...
      // Parse comma-separated skills and create OR conditions for each
      if (skills) {
        ...
        if (skillList.length > 0) {
          const skillConditions = skillList
            .map(
              (skill) => `title.ilike.%${skill}%,description.ilike.%${skill}%`
            )
            .join(",");
  ...
  const getPageDescription = () => {
    if (projectType === "my_projects")
      return "Manage the projects you have created.";
    if (projectType === "accepted_projects")
      return "Track the projects you are working on.";
              ...
              <div className="flex flex-col gap-4 w-full">
                <div className="space-y-2">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <Button
                      size="sm"
                      variant={
                        projectType === "my_projects" ? "solid" : "bordered"
                      }
                      color={
                        projectType === "my_projects" ? "primary" : "default"
                      }
                ...
                <div className="space-y-2">
                  ...
                  <Slider
                    ...
                    className="max-w-md"
                  />
                  <div className="text-small text-default-500 text-right">
                    {minReputation}
                  </div>
                </div>
                <div className="space-y-2">
